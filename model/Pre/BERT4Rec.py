    ...
    def train(self):
        ...
        if self.round2 == 1:
            load_round1_and_enable_shared(
                model,
                '/root/autodl-tmp/fisher_cache/fisher_experts_epoch_bert_beer100.pt',
                enable_shared=True
            )
        ...
        save_path = f"./fisher_cache/fisher_experts_epoch_bert_beer{self.maxEpoch}.pt"
